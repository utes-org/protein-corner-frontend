      ...
      >
        ...
        <div>
          ...
          >
            <motion.button
              ...
              className="items-center justify-center hidden w-6 h-full group shrink-0 focus:text-accent focus:outline-0 ltr:mr-6 rtl:ml-6 lg:flex xl:hidden"
            >
            ...
            <div className="flex flex-wrap items-center shrink-0 grow-0 basis-auto ltr:mr-auto rtl:ml-auto lg:w-auto lg:flex-nowrap">
              <Logo
                className={cn(
                  "py-3",
        ...
        >
          Map
            ...
            <div className="flex items-center shrink-0 space-x-7 rtl:space-x-reverse 2xl:space-x-10">
              <ul className="items-center hidden shrink-0 space-x-7 rtl:space-x-reverse xl:flex 2xl:space-x-10">
                <StaticMenu />
              </ul>
              <div className="flex items-center space-x-4 rtl:space-x-reverse">
                ...
                {settings?.useGoogleMap && (
                  ...
                  >
                    ...
                    >
                      <span className="flex items-center gap-1 text-base text-gray-700 shrink-0 grow-0 basis-auto">
                ...
                {/* <Link
                  ...
                  className="items-center justify-center hidden px-3 py-0 text-sm font-semibold leading-none transition duration-300 ease-in-out border border-transparent rounded outline-none h-9 shrink-0 bg-accent text-light hover:bg-accent-hover focus:shadow focus:outline-none focus:ring-1 focus:ring-accent-700 sm:inline-flex"
                >
