...
const StaticMenu = () => {
  ...
  return (
    <>
      ...
      <li className="relative py-3 mx-3 cursor-pointer menuItem group xl:mx-4">
        {/* <div className="flex items-center gap-2 group-hover:text-accent">
          <span className="relative inline-flex items-center py-2 font-normal text-brand-dark group-hover:text-brand rtl:left-0">
            {t("text-pages")}
          </span>
