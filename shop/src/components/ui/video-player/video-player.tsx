...
function PlayButton() {
  return (
    <button
      ...
      className="z-20 flex items-center justify-center w-20 h-20 duration-200 border-2 border-white rounded-full shadow-lg bg-accent group/actionIcon hover:bg-accent-hover"
    >
...
export function VideoPlayer({ url, thumbnail }: VideoPlayerProps) {
  ...
  return (
    <div
      ...
      className={cn(
        "flex z-10 group flex-col relative lg:overflow-hidden",
